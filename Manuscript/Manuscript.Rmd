...
source("~/Documents/Nick-Grad/Neta_Lab/depletion_study/study2/Analyses/wilcox_test.R")
...
stim.data <- read.xlsx("~/Documents/Nick-Grad/Neta_Lab/depletion_study/study2/Analyses/IAPS_Stim_List.xlsx")
...
data <- read.csv("~/Documents/Nick-Grad/Neta_Lab/depletion_study/study2/Analyses/Final.Data.csv_2019-08-01_12-38-57.csv")
...
shapiro.test(wide$lo.emo.sur_RT)
### make factors ###
RTz.long$Load <- ifelse(RTz.long$Condition == "lo.neu.sur_RT", "Low",
...
```{r plot RT data}
#data.long.summary <- summarySE(data.long, measurevar="ReactionTime", groupvars = "Condition")
